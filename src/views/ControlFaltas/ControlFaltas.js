...
class ControlFaltas extends Component {
  ...
  getControlFaltasAdmin = () => {
    ...
    Database.get('/list-controlfaltas',this,null,true)
      .then(res => {
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <Card style={style}>
            ...
            <CardBody>
              <Button style={{ marginTop: '25px' }} onClick={() => this.props.history.push(this.props.match.url + '/nuevocontrolfalta')} color="primary"><AddIcon /> Nueva Falta</Button>
              <MaterialTable
