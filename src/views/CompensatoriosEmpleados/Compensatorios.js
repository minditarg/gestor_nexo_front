...
class Compensatorios extends Component {
  ...
  getCompensatoriosAdmin = () => {
    ...
    Database.get('/list-compensatorios-empleados',this,null,true)
      .then(res => {
        ...
        if (resultado.length > 0) {
          this.setState({
            isLoading:false,
            minutosTotales: resultado[0].min_totales,
            nombreEmpleado: resultado[0].nombre_empleado,
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <Card style={style}>
            ...
            <br></br>
            <CardHeader color="primary">
                  <h4 className={this.props.classes.cardTitleWhite}>Minutos Totales: {this.state.minutosTotales}</h4> 
            </CardHeader>
              <MaterialTable
